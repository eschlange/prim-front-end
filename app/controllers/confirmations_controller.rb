class ConfirmationsController < Devise::ConfirmationsController
  ...
  def confirm
    ...
    if resource.update_attributes(params[resource_name].except(:confirmation_token).permit(:email, :first_name, :last_name, :password, :password_confirmation, :site_id, :future_contact)) && resource.password_match?
